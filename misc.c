...
const uint8_t     scan_delay_10ms                  =   210 / 10;   // 210ms
    ...
    const uint16_t    dual_watch_count_after_tx_10ms   =  1500 / 10;   // 1.5 sec after TX ends
    const uint16_t    dual_watch_count_after_rx_10ms   =   500 / 10;   // 500ms after RX ends
    const uint16_t    dual_watch_count_after_1_10ms    =  1500 / 10;   // 1.5 sec
    const uint16_t    dual_watch_count_after_2_10ms    =   800 / 10;   // 800ms
...
#endif
const uint16_t    dual_watch_count_toggle_10ms     =   400 / 10;   // 400ms between VFO toggles
